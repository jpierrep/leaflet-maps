...
let plantilla={
	...
	"websites" : [
		{
			"url" : "http://targit2020.guardservice.cl/TouchServer/embed.html#vfs://Personal/Paneles%20CIC/G1/Rango%20vencimiento-proximos%20vencimientos%20detalle.xview",
			"duration" : 60,
...
async function getMatrices(idMatriz,parameter){
  ...
  if (idMatriz==8){
    ...
    //urlBase="http://targit2020.guardservice.cl/TouchServer/embed.html##OPER1?cenco1codi=962-000"
    urlBase="http://targit2020.guardservice.cl/TouchServer/embed.html##" 
...
,{id:7, nombre:"visitas y auditorias cumplimiento",paneles:['OPERACCIONINMEDIATAP7-1?'+baseFilter]}
  ...
  ,{id:9, nombre:"Turnos por confimar",paneles:['OPERACCIONINMEDIATAP9-1?'+baseFilter]}
    ...
    urlBase="http://targit2020.guardservice.cl/TouchServer/embed.html#vfs://Global/Auditorias/"
...
async function getTemplateEndpointsTargit(id){
  ...
  /*
let urlBase="http://targit2020.guardservice.cl/TouchServer/embed.html#vfs://Global/Auditorias/"
...
//urlBase="http://targit2020.guardservice.cl/TouchServer/embed.html##OPER1?cenco1codi=962-000"
let urlBase="http://targit2020.guardservice.cl/TouchServer/embed.html##" 
let panelesTargit=[
...
async function getTemplateEndpointsTargitTodasTest(){
...
let plantilla_websites=JSON.parse(JSON.stringify(plantilla_endpoints.websites[0]))  
let websites=[]
  panelesTargit.forEach(pantalla=>{
    pantalla["paneles"].forEach(panel => {
      let website=JSON.parse(JSON.stringify(plantilla_websites))
      website["url"]=panel
      if (!panel.includes("192.168.0.158:8000")) //filtro mapas 
      websites.push(website)
...
module.exports={getTemplateEndpoints,getTemplateEndpointsTargit,getTemplateEndpointsTargitTodasTest}
